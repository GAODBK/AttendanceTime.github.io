  ...
  <nav>
    <div class="nav-responsive">
      ...
      <div class="nav-search">
        ...
        <input type="text" id="search" placeholder="搜索您的商品、品牌">
      </div>
      <div class="access">
  ...
  <main id="main">
    ...
    <section class="categories">
      <div class="title-container">
        <h1 id="title">最新手机</h1>
        <button type="button" id="item-btn">查看全部</button>
      </div>
      <div class="card">
        <div class="item-container" id="0">
          <div class="card-item">
            <img src="/images/redmiK20.jpg" alt="img" id="card-img">
            <p id="item-name">Redmi K20 (火焰红，6GB RAM，128GB 存储空间)</p>
          </div>
    ...
    <!-- Footer section -->
    <footer>
      <p id="footer-title">our support team</p>
        <div class="footer">
          <div class="support">
            <ul>
              <h3>Know About Us</h3>
      ...
      <div class="items-detail">
        ...
        <div class="details-card">
          ...
          <p id="spec"><strong>Specification :</strong>
            ...
            <ul>
              <li>13MP AI triple main camera + 2MP bokeh (depth of field) camera + 2MP macro camera with photo, video,
                professional mode panorama, portrait, time-lapse etc. | 16MP front punch hole camera
              </li>

              <li>Lorem ipsum, dolor sit amet consectetur adipisicing elit.</li>

              <li>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nihil maxime reiciendis laborum! Velit odit
                molestias architecto doloremque est sapiente.
              </li>
            </ul>
          </p>
  ...
  /*
    {
      ...
      price: 23,
      f_number: 1,
      imgUrl: 'src/images/1green-asparag.jpg',
      desc: ["蔬菜"]
    },
  */
