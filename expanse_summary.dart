import 'package:LYG_JZB/bookkeeping/bar_graph.dart';
import 'package:LYG_JZB/bookkeeping/date_time_helper.dart';
import 'package:LYG_JZB/bookkeeping/expense_data.dart';
...
class ExpanseSummary extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<ExpenseDate>(
      builder: (context,value,child) => Column(children:[
        ...
        Padding(padding: const EdgeInsets.only(top: 35,left: 20,bottom: 5),
          child: Row( children: [
        ...
        SizedBox(
          height: 240,
          child: MyBarGraph(
            maxY: getMaxValue(value, sunday, monday, tuesday,
                wednesday, thursday, friday, saturday),//getMaxValue(),
  ...
  double getMaxValue(
    ...
    values.sort();
    return values.last < 30 ? 30
      : values.last < 60 ? 60
      : values.last < 100 ? 100
      : (values.last / 100.0).ceil() * 115;
  }
